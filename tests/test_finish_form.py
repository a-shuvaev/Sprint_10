...
class TestFinishOrderForm:
    ...
    def test_elements_finish_order_taxi_form(self, open_finish_order_taxi_form):
        page = FinishOrderTaxiPage(open_finish_order_taxi_form)
        
        assert (Data.TEXT_FORM_FINISH_ORDER_TAXI in page.get_text_title_finish_order_taxi_form() and
                page.is_picture_taxi_visible() and
                page.is_car_number_taxi_valid() and
                page.is_picture_car_driver_visible() and
                page.is_rating_car_driver_visible() and
                page.is_name_car_driver_visible() and
                page.get_text_button_return() == Data.TEXT_FORM_RETURN_BUTTON and
                page.get_text_button_details() == Data.TEXT_FORM_DETAILS_BUTTON)
